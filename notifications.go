...
type NotificationRequest struct {
	...
	// Chrome 56+: Sets the web push notification's large image to be shown below the notification's title and text. Please see https://documentation.onesignal.com/docs/web-push-notification-icons
